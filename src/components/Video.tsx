...
export function Video() {
  return (
    <div className="flex-1">
      ...
      <div className="p-8 max-w-[1100vh] mx-auto">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              <img
                ...
                src="https://github.com/Dev-Joanderson.png"
                alt=""
              />
              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Joanderson Trajano</strong>
                <span className="text-gray-200 text-sm block">Aluno @Rocketseat</span>
              </div>
            </div>
          </div>
        ...
        <div className="gap-8 mt-20 grid grid-cols-2">
          ...
          >
            ...
            <div className="py-6 leading-relaxed">
              ...
              <p className="tex-sm text-gray-200 mt-2">
